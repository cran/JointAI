...
[`glme_imp()`](https://nerler.github.io/JointAI/reference/model_imp.html) and
[`survreg_imp()`](https://nerler.github.io/JointAI/reference/model_imp.html) have an argument
`monitor_params`.
