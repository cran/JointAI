...
Of course there are many more parameters that can or should
be specified.
...
2.5% and 97.5% quantiles of the MCMC sample, the tail probability and the 
...
* **Cox proportional hazards survival models**: `coxph_imp()` (follows the specification
